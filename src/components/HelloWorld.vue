<template>
  <div class="hello">
    <div>
      ...
      <input class="border border-gray-500" type="text" v-model="state.msg">
      <button class="ml-4 border border-[tomato]" @click="passMsg2Parent">click me return value</button>
    </div>
  </div>
</template>
